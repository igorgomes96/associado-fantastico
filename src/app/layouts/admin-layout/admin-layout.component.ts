...
export class AdminLayoutComponent implements OnInit, AfterViewInit {
    ...
    ngOnInit() {
        ...
        if (window.matchMedia(`(min-width: 960px)`).matches && !this.isMac()) {
            let ps = new PerfectScrollbar(this.elemMainPanel as HTMLElement);
            ps = new PerfectScrollbar(this.elemSidebar as HTMLElement);
        }
    ...
    private get elemMainPanel() {
        return document.querySelector('.main-panel');
    }

    private get elemSidebar() {
        return document.querySelector('.sidebar .sidebar-wrapper');
    }
